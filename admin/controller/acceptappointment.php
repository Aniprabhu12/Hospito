...
$mail->Subject = ("Confirmation of Your Appointment with Dr. $docname [$dept] ");
$mailContent = "<h4>Dear $name,<br>
    
    We are pleased to inform you that your appointment with Dr. $docname [$dept] has been successfully confirmed.<br>
    Appointment Details:<br>
Doctor: Dr. $docname <br>
Date:  $apdate <br>
Time: $aptime
    </h4>";
...
if ($mail->send()) {
    ...
    $stmt = $admin->cud("UPDATE `appointment` SET `ap_status`='accepted',`notification_status`='unread' WHERE `ap_id`='$apid'", "updated");
